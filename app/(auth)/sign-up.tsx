      ...
      <View className="flex-1 bg-neutral-900">
        ...
        <View className="p-5">
          ...
          <Link href="/log-in" className="mt-10 text-center text-neutral-400">
            ...
            <Text className="text-center text-green-400 underline">Log In</Text>
          </Link>
        </View>
        {/* This only appears when pending state has been set. */}
        <AuthModal
          isVisible={verification.state === "pending"}
          onClose={() => setVerification({ ...verification, state: "success" })}
        >
        ...
        <AuthModal isVisible={verification.state === "success"}>
          <View className="bg-neutral-800 px-7 py-9 rounded-2xl min-h-[300px]">
            <Image
              source={images.check}
